...
/**
 * Verifica se um quarto está disponível para uma estadia com base nas datas de entrada e saída.
 * @param data_entrada Data de entrada da estadia
 * @param data_saida Data de saída da estadia
 * @return 1 se o quarto está disponível, 0 caso contrário
 */
